    ...
    <div className="space-y-4">
      ...
      <div className="card p-0 overflow-auto">
        <table className="table">
          <thead><tr><th>名前</th><th>カナ</th><th>性</th><th>生年</th><th>支援</th><th>並び順</th><th></th></tr></thead>
          <tbody>
            {(horses ?? []).map((h: any) => (
              <tr key={h.id}>
            ...
            {(horses ?? []).length === 0 && (
              <tr><td colSpan={7} className="text-center py-6 text-ink-mute">まだ登録されていません。</td></tr>
            )}
          </tbody>
        </table>
      </div>
